...
var Game = /** @class */ (function () {
    ...
    Game.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        boardDimensions = this.board.getBoard();
                        console.log(boardDimensions);
                        _a.label = 1;
                    case 1: return [4 /*yield*/, this.processUserInput()];
                    case 2:
    ...
    Game.prototype.getCol = function (array, col) {
        return array.map(function (zeile) { return zeile[col]; });
    };
    Game.prototype.getRow = function (array, row) {
        return array[row];
    };
    return Game;
}());
